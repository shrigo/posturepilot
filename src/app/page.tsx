...
export default function Page() {
  ...
  return(
    <div id="top" style={{fontFamily:"Inter,sans-serif",background:"#fff",color:"#0f172a",minHeight:"100vh"}}>
      ...
      <section style={{background:"linear-gradient(135deg,#f5f3ff 0%,#eff6ff 50%,#f0fdf4 100%)",minHeight:"85vh",display:"flex",alignItems:"flex-start",padding:"4rem 3rem 1rem",position:"relative",overflow:"hidden"}}>
        {/* Subtle radial glow */}
