...
export default function ShieldViz(){
  ...
  if(!mounted) return(
    <div style={{position:'relative',width:'100%',maxWidth:713,margin:'0 auto'}}>
      <Image src="/pphr_shield.gif" alt="PosturePilot Command Center"
    ...
    <div style={{position:'relative',width:'100%',maxWidth:713,margin:'0 auto'}}>
      ...
      <svg viewBox="0 0 620 620"
          ...
          {['CIS Audit','SOC2 Gate','GRC Pass'].map((label,i)=>{
            ...
            return(
              <g key={i}>
                ...
                />
                <text x="429" y={y+4} fontSize="8.5" fontWeight="800"
        ...
        <g transform="rotate(5, 445, 280)">
          <text x="445" y="275" textAnchor="middle" dominantBaseline="middle" fontSize="9" fontWeight="900"
