    ...
    <div style={{ fontFamily: "Inter, sans-serif", background: "#f8fafc", minHeight: "100vh", color: "#0f172a" }}>
      <nav style={{ 
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1.25rem" }}>
          <Link href="/" style={{
            color: "#4f46e5", textDecoration: "none", border: "1px solid #c4b5fd", padding: "0.45rem 1rem", borderRadius: "10px", fontSize: "0.8rem", fontWeight: 800, display: "flex", alignItems: "center", gap: "0.3rem", boxShadow: "0 2px 10px rgba(79,70,229,0.05)", transition: "all 0.2s", background: "transparent"
          }}
